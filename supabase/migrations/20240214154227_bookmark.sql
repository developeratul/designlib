...
alter table "public"."bookmarks" add constraint "bookmarks_resourceId_key" UNIQUE using index "bookmarks_resourceId_key";

alter table "public"."bookmarks" add constraint "bookmarks_userId_fkey" FOREIGN KEY ("userId") REFERENCES users(id) ON DELETE CASCADE not valid;
